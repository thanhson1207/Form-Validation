function Validator(options) {
    ...
    if (formElement) {
        ...
        //validate tất cả các rule khi bấm submit
        formElement.onsubmit = function (e) {
            ...
            if (isFormValid) {
                ...
                //truong hop submit vs html mac dinh
                else {
                    formElement.submit();
                }
            }
        ...
        //validate từng rule và xử lý(blur, input, ....)
        options.rules.forEach(function (rule) {
            //Lưu lại các rules
